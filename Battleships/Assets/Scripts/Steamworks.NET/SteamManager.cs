...
public class SteamManager : MonoBehaviour {
...
#if UNITY_EDITOR && UNITY_STANDALONE_WIN
        // Unload the native steam_api64.dll to prevent Unity process crash
        UnloadSteamDll();
#endif
#endif
    }
    ...
    static void UnloadSteamDll()
    {
        IntPtr handle = GetModuleHandle("steam_api64.dll");
        if (handle != IntPtr.Zero)
        {
            bool result = FreeLibrary(handle);
            UnityEngine.Debug.Log("Freed steam_api64.dll: " + result);
        }
        else
        {
            UnityEngine.Debug.Log("steam_api64.dll not found");
        }
    }
#endif
